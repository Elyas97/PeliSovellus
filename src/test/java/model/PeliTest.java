...
class PeliTest {
	...
	@Test
	void testGetPeliId() {
		Peli peli = new Peli("Mario Kart", 2, "Videopeli", "Vuokraus", 2, "Jännitys", "Playstation", 8, 2, "Kelpo peli",
				"Helsinki", "Hyvä", "Puh: 040 123456", paiva);
	...
	@Test
	void testSetTekstikenttä() {
		Peli peli = new Peli();
		peli.setTekstikenttä("Puhelin: 040 1234567");
		assertTrue(peli.getTekstikenttä() == "Puhelin: 040 1234567");
	}

	@Test
	void testGetTekstikenttä() {
		Peli peli = new Peli("Mario Kart", 2, "Videopeli", "Vuokraus", 2, "Jännitys", "Playstation", 8, 2, "Kelpo peli",
				"Helsinki", "Hyvä", "Puh: 040 123456", paiva);
		assertEquals("Puh: 040 123456", peli.getTekstikenttä(), "Pelin tekstikenttä väärin.");
	}
	...
	void testGetKonsoli() {
		Peli peli = new Peli("Mario Kart", 2, "Videopeli", "Vuokraus", 2, "Jännitys", "Playstation", 8, 2, "Kelpo peli",
				"Helsinki", "Hyvä", "Puh: 040 123456", paiva);
		assertEquals("Playstation", peli.getKonsoli(), "Pelin konsoli väärin.");
	}

	@Test
	void testSetKonsoli() {
		Peli peli = new Peli();
		peli.setKonsoli("Playstation");
		assertTrue(peli.getKonsoli() == "Playstation");
	}
}
